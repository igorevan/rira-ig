# Problema/Diagnóstico - Guia de Implementação do Registro de Regulação Assistencial (RIRA) da RNDS v1.0.0-release
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/br.gov.saude.rira.fhir|current/StructureDefinition/StructureDefinition-BRProblemaDiagnostico.json)
...
Other representations of profile: [CSV](../StructureDefinition-BRProblemaDiagnostico.csv), [Excel](../StructureDefinition-BRProblemaDiagnostico.xlsx), [Schematron](../StructureDefinition-BRProblemaDiagnostico.sch) 
...
```json
{
  ...
  "meta" : {
    "lastUpdated" : "2023-04-11T17:00:19.9153862+00:00"
  },
  "language" : "pt-BR",
  "extension" : [{
  ...
  "url" : "http://www.saude.gov.br/fhir/r4/StructureDefinition/BRProblemaDiagnostico",
  "version" : "1.0.0-release",
  "name" : "BRProblemaDiagnostico",
  "title" : "Problema/Diagnóstico",
  "status" : "active",
  "date" : "2023-03-30T00:00:00.0000000+00:00",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "description" : "Categoria da condição.",
        "valueSet" : "http://www.saude.gov.br/fhir/r4/ValueSet/BRCategoriaCondicao"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "description" : "Identificação do problema/diagnóstico",
    ...
    },
    {
      ...
      "short" : "Nota",
      "definition" : "Informações complementares textuais acerca problema/diagnostico.",
      "mustSupport" : true
    }]
  }
}
