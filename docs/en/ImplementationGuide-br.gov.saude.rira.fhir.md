...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-06-15T17:23:04-03:00",
  ...
  "definition" : {
    ...
    },
    {
      ...
      "name" : "Status de agendamento de regulação assistencial (CodeSystem)",
    ...
    },
    {
      ...
      "name" : "Status de agendamento de regulação assistencial (ValueSet)",
      "description" : "Status de agendamento de regulação assistencial."
    },
    {
      "extension" : [{
