# Justificativa da Impossibilidade de Identificação do Indivíduo (CodeSystem) - Guia de Implementação do Registro de Regulação Assistencial (RIRA) da RNDS v1.0.0-release
