# Classificação Internacional de Atenção Primária - Segunda Edição - CIAP2 - Guia de Implementação do Registro de Regulação Assistencial (RIRA) da RNDS v1.0.0-release
...
```json
{
  ...
  "id" : "BRCIAP2",
  "meta" : {
    "lastUpdated" : "2020-03-11T19:10:04.975+00:00"
  },
  "language" : "pt-BR",
  "extension" : [{
