# Bundle de exemplo do RIRA (Pendente) - Guia de Implementação da Regulação Assistencial (RIRA) da RNDS v1.0.0

* [**Índice**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Bundle de exemplo do RIRA (Pendente)**

## Example Bundle: Bundle de exemplo do RIRA (Pendente)
...
**status**: Booked**serviceCategory**:Atenção Hospitalar**serviceType**: Nenhum ecrã para Appointment.serviceType (concept: COLONOSCOPIA (COLOSCOPIA))**specialty**:MEDICO CIRURGIAO GERAL**appointmentType**:Routine**start**: 2021-11-29 08:40:00-0300**end**: 2021-11-29 08:40:00-0300**created**: 2021-11-03 07:56:13-0300**basedOn**:[ServiceRequest CONSULTA MEDICA EM ATENÇÃO ESPECIALIZADA](Bundle-Example-RIRA-Attended.md#urn-uuid-transient-2)
...
| :--- | :--- | :--- | :--- |
| - | **Type** | **Actor** | **Status** |
| * | Paciente | Identifier:`http://www.saude.gov.br/fhir/r4/StructureDefinition/BRIndividuo-1.0`/708108612093340 | Accepted |
...
**status**: Active**intent**: Proposal**category**:Atenção Hospitalar**priority**: Routine**code**: Nenhum ecrã para ServiceRequest.code (concept: COLONOSCOPIA (COLOSCOPIA))**subject**: Identifier:`http://www.saude.gov.br/fhir/r4/StructureDefinition/BRIndividuo-1.0`/708108612093340**authoredOn**: 2021-11-02 23:18:43-0300**requester**: Identifier:`http://www.saude.gov.br/fhir/r4/StructureDefinition/BREstabelecimentoSaude-1.0`/6994547**performerType**:MEDICO CIRURGIAO GERAL**performer**: Identifier:`http://www.saude.gov.br/fhir/r4/StructureDefinition/BREstabelecimentoSaude-1.0`/0440620
...
**clinicalStatus**:Active**category**:Principal**code**:Hemorragia gastrointestinal, sem outra especificação**subject**: Identifier:`http://www.saude.gov.br/fhir/r4/StructureDefinition/BRIndividuo-1.0`/708108612093340**note**:
> 
  ...
  "entry" : [
    ...
    },
    {
      ...
      "resource" : {
        ...
        "text" : {
          "status" : "generated",
          "div" : "<div xmlns=\"http://www.w3.org/1999/xhtml\"><a name=\"Condition_null\"> </a><p class=\"res-header-id\"><b>Narrativa gerada: Condition </b></p><div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\"><p style=\"margin-bottom: 0px\"/><p style=\"margin-bottom: 0px\">Perfil: <a href=\"StructureDefinition-BRCID10Avaliado-1.0.html\">CID10 Avaliado</a></p></div><p><b>clinicalStatus</b>: <span title=\"Códigos:{http://terminology.hl7.org/CodeSystem/condition-clinical active}\">Active</span></p><p><b>category</b>: <span title=\"Códigos:{http://www.saude.gov.br/fhir/r4/CodeSystem/BRCategoriaDiagnostico 01}\">Principal</span></p><p><b>code</b>: <span title=\"Códigos:{http://www.saude.gov.br/fhir/r4/CodeSystem/BRCID10 K922}\">Hemorragia gastrointestinal, sem outra especificação</span></p><p><b>subject</b>: Identifier: <code>http://www.saude.gov.br/fhir/r4/StructureDefinition/BRIndividuo-1.0</code>/708108612093340</p><p><b>note</b>: </p><blockquote><div><p>Sem observações</p>\n</div></blockquote></div>"
        },
        "clinicalStatus" : {
          "coding" : [
            {
