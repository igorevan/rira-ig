# Status de regulação assistencial - Guia de Implementação da Regulação Assistencial (RIRA) da RNDS v1.0.0

* [**Índice**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Status de regulação assistencial**

## ValueSet: Status de regulação assistencial 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://www.saude.gov.br/fhir/r4/ValueSet/BRStatusRegulacaoAssistencial | *Version*:1.0.0 | |
...
* Include todos os códigos definidos em `http://www.saude.gov.br/fhir/r4/CodeSystem/BRStatusRegulacaoAssistencial`versão 📍
...
```json
{
  ...
  "url" : "http://www.saude.gov.br/fhir/r4/ValueSet/BRStatusRegulacaoAssistencial",
  "version" : "1.0.0",
  "name" : "BRStatusRegulacaoAssistencial",
  "title" : "Status de regulação assistencial",
  "status" : "active",
  "experimental" : false,
