...
Expansão a partir de tx.fhir.org com base em [codesystem Status da regulação assistencial v1.0.0 (CodeSystem)](CodeSystem-BRStatusRegulacaoAssistencial.md)
