...
## ValueSet: Status de agendamento de regulação assistencial 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://www.saude.gov.br/fhir/r4/ValueSet/BRStatusAgendamentoRegulacaoAssistencial | *Version*:1.0.0 | |
...
* Incluir estes códigos, tal como definidos em [`http://hl7.org/fhir/appointmentstatus`](http://tx.fhir.org/r4)versão 📍4.0.1
* Incluir todos os códigos definidos em `http://www.saude.gov.br/fhir/r4/CodeSystem/BRStatusAgendamentoRegulacaoAssistencial`versão 📍
