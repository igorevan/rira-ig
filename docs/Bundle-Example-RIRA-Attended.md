# Bundle de exemplo do RIRA (Atendido/Internado) - Guia de Implementação da Regulação Assistencial (RIRA) da RNDS v1.0.0

* [**Índice**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Bundle de exemplo do RIRA (Atendido/Internado)**

## Example Bundle: Bundle de exemplo do RIRA (Atendido/Internado)
