# CID10 Avaliado - Guia de Implementação da Regulação Assistencial (RIRA) da RNDS v1.0.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://www.saude.gov.br/fhir/r4/StructureDefinition/BRCID10Avaliado-1.0 | *Version*:1.0.0 | |
| *Standards status:*[Informative](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Computable Name*:BRCID10Avaliado |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/br.gov.saude.rira.fhir|current/StructureDefinition/BRCID10Avaliado-1.0)
...
Other representations of profile: [CSV](StructureDefinition-BRCID10Avaliado-1.0.csv), [Excel](StructureDefinition-BRCID10Avaliado-1.0.xlsx), [Schematron](StructureDefinition-BRCID10Avaliado-1.0.sch) 
...
```json
{
  ...
  "id" : "BRCID10Avaliado-1.0",
  "meta" : {
    "lastUpdated" : "2023-08-16T17:21:02.7270079+00:00"
  },
  "language" : "pt-BR",
  "extension" : [
    {
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "Indivíduo",
        "definition" : "Indica o indivíduo ao qual o CID-10 se refere.",
        "type" : [
          {
            "code" : "Reference",
            "targetProfile" : [
      ...
      {
        "id" : "Condition.subject.extension:unidentifiedPatient.extension:gender.url",
        "path" : "Condition.subject.extension.extension.url",
        "fixedUri" : "gender"
      },
      {
      ...
      {
        "id" : "Condition.subject.extension:unidentifiedPatient.extension:birthYear.url",
        "path" : "Condition.subject.extension.extension.url",
        "fixedUri" : "birthYear"
      },
      {
      ...
      {
        "id" : "Condition.subject.extension:unidentifiedPatient.extension:reason.url",
        "path" : "Condition.subject.extension.extension.url",
        "fixedUri" : "reason"
      },
      {
      ...
      },
      {
        ...
        "definition" : "Indica a data do início do diagnóstico ou problema identificado.",
        "type" : [
          {
            "code" : "dateTime"
          }
      ...
      },
      {
        ...
        "short" : "Nota",
        "definition" : "Informações complementares textuais acerca do CID-10 avaliado.",
        "mustSupport" : true
      }
    ]
  }
