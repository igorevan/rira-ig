# Bundle de exemplo do RIRA (Anterior à 2025 com CID-10) - Guia de Implementação do Registro de Regulação Assistencial (RIRA) da RNDS v1.0.0-release

## Example Bundle: Bundle de exemplo do RIRA (Anterior à 2025 com CID-10)
...
{
  "resourceType" : "Bundle",
  "id" : "example-rira-anterior-2025-com-cid",
  "identifier" : {
